...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        self.patchToApply["editaja"] = [("phase5.patch", 2), ("build-fixes.patch", 1), ("phase6.patch", 1), ("phase12.patch", 1), ("phase13.patch", 1), ("phase14.patch", 1), ("phase15.patch", 1), ("subtitle-initialization.patch", 1), ("keyframe-api-compile-fix.patch", 1), ("save-project-agent.patch", 1), ("ai-agent-sidebar.patch", 1), ("creator-workspace-filmora.patch", 1), ("ai-agent-toolbox.patch", 1), ("creator-layout-filmora.patch", 1)]
